...
** `[[https://github.com/orzechowskid/tsx-mode.el/tree/emacs29][tsx-mode]]

Checked out branch ~emacs29~.

#+begin_src emacs-lisp :tangle no
(use-package tsx-mode
  :load-path "~/src/github/elisp/tsx-mode.el"
  :mode ("\\.tsx\\'")
  :config
  (use-package tree-sitter-css-in-js
    :load-path "~/src/github/elisp/tree-sitter-css-in-js")
  (use-package corfu)
