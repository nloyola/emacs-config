...
(use-package emacs
  ...
  (defun nl/mode-line-theme ()
    ...
    (set-face-attribute 'mode-line-buffer-id nil :foreground "goldenrod" :height 0.6 :weight 'semi-bold :inherit 'variable-pitch)
    (set-face-attribute 'mode-line-emphasis nil :weight 'bold :inherit 'fixed-pitch)
  ...
  (setq-default
   ...
   (list
    ...
    (propertize "%c" 'face '(:foreground "light sky blue"))
    "] "
    ...
    "/"
    (propertize "%I" 'face '(:foreground "salmon")) ;; size
    ") "
