...
(defvar nl/gui-variable-font-name "Alegreya")
;;(defvar nl/gui-variable-font-name "Go")

(defconst nl/gui-fixed-font-size-normal 11)

(use-package emacs
  :preface
  (defun nl/set-fonts (frame)
    "Set the desired fonts for a frame. FRAME can be nil."
    (let ((fixed-font-name (format "%s %s" nl/gui-fixed-font-name nl/gui-fixed-font-size-normal))
          (variable-font-name (format "%s %s" nl/gui-variable-font-name nl/gui-fixed-font-size-normal)))
      (set-face-attribute 'default nil :family nl/gui-fixed-font-name :height 120)
      ;;(set-frame-font fixed-font-name)
      ...
      (set-face-attribute 'font-lock-comment-face nil :family nl/gui-fixed-font-name :weight 'semi-bold :slant 'italic :inherit 'default)
      ...
      (set-face-attribute 'mode-line-buffer-id nil :family nl/gui-variable-font-name :foreground "goldenrod" :weight 'semi-bold)
      (set-face-attribute 'mode-line-emphasis nil :family nl/gui-variable-font-name :weight 'bold)
      (set-face-attribute 'mode-line-highlight nil :family nl/gui-variable-font-name :slant 'italic)
      ))
  :config
...
(add-to-list 'display-buffer-alist
             ;; '("\\(?:\\*\\(?:grep\\|Find\\|Warnings\\|xref\\|eat\\)\\*\\)"
             '("\\(?:\\*\\(?:grep\\|Find\\|Warnings\\|xref\\)\\*\\)"
               display-buffer-in-side-window
               (window-height . 0.18)
               (side . bottom)
               (slot . -1) ;; left side
...
(add-to-list 'display-buffer-alist
             '("\\*\\(?:Backtrace\\|Warnings\\|Completions\\|Compile-Log\\|cargo-run\\|\\Flycheck.*\\)\\*"
               display-buffer-in-side-window
               (window-height . 0.2)
               (side . bottom)
               (slot . 1) ;; right side
...
(use-package doom-themes
  ...
  ;; (doom-themes-treemacs-file-face ((t (:inherit fixed-pitch))))
  ;; (doom-themes-treemacs-root-face ((t (:inherit fixed-pitch))))
  ;; (treemacs-directory-collapsed-face ((t (:inherit fixed-pitch))))
  ;; (treemacs-directory-face ((t (:inherit fixed-pitch))))
  ;; (treemacs-file-face ((t (:inherit fixed-pitch))))
  ;; (treemacs-fringe-indicator-face ((t (:inherit fixed-pitch))))
  ;; (treemacs-git-added-face ((t (:inherit fixed-pitch))))
  ;; (treemacs-git-commit-diff-face ((t (:inherit fixed-pitch))))
  ;; (treemacs-git-conflict-face ((t (:inherit fixed-pitch))))
  ;; (treemacs-git-ignored-face ((t (:inherit fixed-pitch))))
  ;; (treemacs-git-modified-face ((t (:inherit fixed-pitch))))
  ;; (treemacs-git-renamed-face ((t (:inherit fixed-pitch))))
  ;; (treemacs-git-unmodified-face ((t (:inherit fixed-pitch))))
  ;; (treemacs-git-untracked-face ((t (:inherit fixed-pitch))))
  ;; (treemacs-header-button-face ((t (:inherit fixed-pitch))))
  ;; (treemacs-help-column-face ((t (:inherit fixed-pitch))))
  ;; (treemacs-help-title-face ((t (:inherit fixed-pitch))))
  ;; (treemacs-hl-line-face ((t (:inherit fixed-pitch))))
  ;; (treemacs-marked-file-face ((t (:inherit fixed-pitch))))
  ;; (treemacs-on-failure-pulse-face ((t (:inherit fixed-pitch))))
  ;; (treemacs-on-success-pulse-face ((t (:inherit fixed-pitch))))
  ;; (treemacs-peek-mode-indicator-face ((t (:inherit fixed-pitch))))
  ;; (treemacs-root-face ((t (:inherit fixed-pitch))))
  ;; (treemacs-root-remote-disconnected-face ((t (:inherit fixed-pitch))))
  ;; (treemacs-root-remote-face ((t (:inherit fixed-pitch))))
  ;; (treemacs-root-remote-unreadable-face ((t (:inherit fixed-pitch))))
  ;; (treemacs-root-unreadable-face ((t (:inherit fixed-pitch))))
  ;; (treemacs-tags-face ((t (:inherit fixed-pitch))))
  ;; (treemacs-term-node-face ((t (:inherit fixed-pitch))))
  ;; (treemacs-window-background-face ((t (:inherit fixed-pitch))))
  )
#+end_src
...
** [[https://github.com/kickingvegas/casual-dired][casual-dired]]
...
(use-package lsp-ui
  ...
  (add-hook 'lsp-ui-doc-frame-hook
            (lambda (frame _w)
              (set-face-attribute 'default frame :family nl/gui-variable-font-name :height 120)))
...
(use-package yasnippet
  ...
  (setq yas-snippet-dirs
      '("~/.emacs.d/snippets"                 ;; personal snippets
        "~/.emacs.d/elpa/yasnippet-snippets-20240507.943/snippets"
        ))
  (yas-reload-all))
#+end_src
