...
(use-package ansi-color
  ...
  :config
  ;; Customize ANSI colors if you like
  (set-face-attribute 'ansi-color-red nil :background "#440000")
  (set-face-attribute 'ansi-color-blue nil :background "#000055"))
#+end_src
...
(defun nl/consult-ripgrep-project-src ()
  "Run `consult-ripgrep` in the Projectile project root."
  (interactive)
  (let ((project-root (concat (projectile-project-root) nl/project-src-folder "/")))
    (if project-root
...
(use-package yaml-mode
  ...
  (defun nl/nordita-build-page-from-yaml ()
    ...
    (let* ((default-directory (project-root (project-current)))
      ...
      ;; (compile
      ;;  (format "./docker-wrapper.sh cli pw-page %s build --no-ansi -f -i ../default_pages/main_site" base-name))
      (compile
