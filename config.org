...
(use-package doom-themes
  ...
  (org-level-1 ((t (:inherit outline-1 :font "Go" :height 196))))
  (org-level-2 ((t (:inherit outline-2 :font "Go" :height 172))))
  (org-level-3 ((t (:inherit outline-3 :font "Go" :height 144))))
  (org-level-4 ((t (:inherit outline-4 :font "Go" :height 136))))
  (org-level-5 ((t (:inherit outline-5 :font "Go" :height 124))))
...
It takes a few seconds to load and I don't need them immediately when Emacs starts up, so we can defer loading
yasnippet until there's some idle time.
