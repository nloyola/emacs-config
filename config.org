...
(defun nl/set-favorite-font-size (size)
  ...
  (let ((fav-font (format "%s-%d" nl/gui-fixed-font-name size)))
    ...
    (set-face-attribute 'variable-pitch nil :family nl/gui-variable-font-name :inherit 'default :height 1.2)))
...
(defun font-monitor-size-default ()
  ...
  (cond
   ...
   ((s-starts-with? "imac" system-name) (nl/imac-fontsize))
...
(defun font-laptop-size-default ()
  ...
  (if (eq system-type 'gnu/linux)
      (nl/linux-laptop-fontsize)
    (nl/mac-laptop-fontsize)))
